	...
	<body>
		...
		<script type="text/javascript">
			...
			function QueryInput(){
				...
				var s_Pcg1=document.getElementById("s_Pcg1")
				var s_Status=document.getElementById("s_Status")
				var s_Year=document.getElementById("s_Year")
				window.location.href="/practice/search?s_Punit="+s_Punit.value+"&s_Pname="+s_Pname.value+"&s_Pcg1="+s_Pcg1.value+"&s_Status="+s_Status.value+"&s_Year="+s_Year.value
			}
			function AddInput(){
